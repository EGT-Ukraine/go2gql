...
func (SomeEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_example_97fe34df5d478ecf, []int{0}
}
...
func (ASomeEnum3) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_example_97fe34df5d478ecf, []int{0, 0}
}

type A struct {
	MapEnum            map[int32]SomeEnum             `protobuf:"bytes,1,rep,name=map_enum,json=mapEnum,proto3" json:"map_enum,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=example.hello.SomeEnum"`
	...
	REnum              []SomeEnum                     `protobuf:"varint,6,rep,packed,name=r_enum,json=rEnum,proto3,enum=example.hello.SomeEnum" json:"r_enum,omitempty"`
	NREnum             ASomeEnum3                     `protobuf:"varint,7,opt,name=n_r_enum,json=nREnum,proto3,enum=example.hello.ASomeEnum3" json:"n_r_enum,omitempty"`
	...
	EnumFromContext    SomeEnum                       `protobuf:"varint,11,opt,name=enum_from_context,json=enumFromContext,proto3,enum=example.hello.SomeEnum" json:"enum_from_context,omitempty"`
	...
	EnumFromOther        a.HelloEnum `protobuf:"varint,14,opt,name=enum_from_other,json=enumFromOther,proto3,enum=hello.a.HelloEnum" json:"enum_from_other,omitempty"`
...
func (m *A) GetEnumFromOther() a.HelloEnum {
	if m != nil {
		return m.EnumFromOther
	}
	return a.HelloEnum_Val1
}
...
func (*AOneOffs) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_97fe34df5d478ecf, []int{1}
}
...
type AOneOffs_ENREnum struct {
	ENREnum SomeEnum `protobuf:"varint,7,opt,name=e_n_r_enum,json=eNREnum,proto3,enum=example.hello.SomeEnum,oneof"`
}
...
type AOneOffs_SNREnum struct {
	SNREnum SomeEnum `protobuf:"varint,11,opt,name=s_n_r_enum,json=sNREnum,proto3,enum=example.hello.SomeEnum,oneof"`
}
...
type AOneOffs_MNREnum struct {
	MNREnum SomeEnum `protobuf:"varint,15,opt,name=m_n_r_enum,json=mNREnum,proto3,enum=example.hello.SomeEnum,oneof"`
}
...
func (*MsgWithEmpty) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_97fe34df5d478ecf, []int{2}
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_97fe34df5d478ecf, []int{3}
}
...
type B struct {
	...
	RScalar              []int32                        `protobuf:"varint,5,rep,packed,name=r_scalar,json=rScalar,proto3" json:"r_scalar,omitempty"`
	REnum                []SomeEnum                     `protobuf:"varint,6,rep,packed,name=r_enum,json=rEnum,proto3,enum=example.hello.SomeEnum" json:"r_enum,omitempty"`
	NREnum               SomeEnum                       `protobuf:"varint,7,opt,name=n_r_enum,json=nREnum,proto3,enum=example.hello.SomeEnum" json:"n_r_enum,omitempty"`
	NRScalar             int32                          `protobuf:"varint,8,opt,name=n_r_scalar,json=nRScalar,proto3" json:"n_r_scalar,omitempty"`
	NRMsg                *timestamp.Timestamp           `protobuf:"bytes,9,opt,name=n_r_msg,json=nRMsg,proto3" json:"n_r_msg,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
...
func (*B) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_97fe34df5d478ecf, []int{4}
}
...
func init() {
	proto.RegisterType((*A)(nil), "example.hello.A")
	proto.RegisterMapType((map[int32]SomeEnum)(nil), "example.hello.A.MapEnumEntry")
	proto.RegisterMapType((map[int32]*timestamp.Timestamp)(nil), "example.hello.A.MapMsgEntry")
	proto.RegisterMapType((map[int32]int32)(nil), "example.hello.A.MapScalarEntry")
	proto.RegisterType((*AOneOffs)(nil), "example.hello.AOneOffs")
	proto.RegisterType((*MsgWithEmpty)(nil), "example.hello.MsgWithEmpty")
	proto.RegisterType((*Empty)(nil), "example.hello.Empty")
	proto.RegisterType((*B)(nil), "example.hello.B")
	proto.RegisterMapType((map[int32]SomeEnum)(nil), "example.hello.B.MapEnumEntry")
	proto.RegisterMapType((map[int32]*timestamp.Timestamp)(nil), "example.hello.B.MapMsgEntry")
	proto.RegisterMapType((map[int32]int32)(nil), "example.hello.B.MapScalarEntry")
	proto.RegisterEnum("example.hello.SomeEnum", SomeEnum_name, SomeEnum_value)
	proto.RegisterEnum("example.hello.ASomeEnum3", ASomeEnum3_name, ASomeEnum3_value)
}
...
func (c *serviceExampleClient) GetQueryMethod(ctx context.Context, in *AOneOffs, opts ...grpc.CallOption) (*B, error) {
	out := new(B)
	err := c.cc.Invoke(ctx, "/example.hello.ServiceExample/getQueryMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceExampleClient) MutationMethod(ctx context.Context, in *B, opts ...grpc.CallOption) (*A, error) {
	out := new(A)
	err := c.cc.Invoke(ctx, "/example.hello.ServiceExample/mutationMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceExampleClient) QueryMethod(ctx context.Context, in *timestamp.Timestamp, opts ...grpc.CallOption) (*timestamp.Timestamp, error) {
	...
	err := c.cc.Invoke(ctx, "/example.hello.ServiceExample/queryMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceExampleClient) GetMutatuionMethod(ctx context.Context, in *MsgWithEmpty, opts ...grpc.CallOption) (*MsgWithEmpty, error) {
	...
	err := c.cc.Invoke(ctx, "/example.hello.ServiceExample/getMutatuionMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceExampleClient) GetEmptiesMsg(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/example.hello.ServiceExample/getEmptiesMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ServiceExample_GetQueryMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.hello.ServiceExample/GetQueryMethod",
	}
...
func _ServiceExample_MutationMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.hello.ServiceExample/MutationMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceExample_QueryMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.hello.ServiceExample/QueryMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceExample_GetMutatuionMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.hello.ServiceExample/GetMutatuionMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceExample_GetEmptiesMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.hello.ServiceExample/GetEmptiesMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ServiceExample_serviceDesc = grpc.ServiceDesc{
	ServiceName: "example.hello.ServiceExample",
...
func init() { proto.RegisterFile("example.proto", fileDescriptor_example_97fe34df5d478ecf) }

var fileDescriptor_example_97fe34df5d478ecf = []byte{
	// 868 bytes of a gzipped FileDescriptorProto
	,
}
