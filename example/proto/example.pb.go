...
func (SomeEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_example_fef049599ab3f8fd, []int{0}
}
...
func (ASomeEnum3) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_example_fef049599ab3f8fd, []int{2, 0}
}
...
func (*ListSomeEntitiesRequest_Filter) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_fef049599ab3f8fd, []int{0, 0}
}
...
func (*ListSomeEntitiesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_fef049599ab3f8fd, []int{1}
}
...
func (*ListSomeEntitiesResponse_SomeEntity) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_fef049599ab3f8fd, []int{1, 0}
}
...
type A struct {
	MapEnum            map[int32]SomeEnum             `protobuf:"bytes,1,rep,name=map_enum,json=mapEnum,proto3" json:"map_enum,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=proto.SomeEnum"`
	...
	REnum              []SomeEnum                     `protobuf:"varint,6,rep,packed,name=r_enum,json=rEnum,proto3,enum=proto.SomeEnum" json:"r_enum,omitempty"`
	NREnum             ASomeEnum3                     `protobuf:"varint,7,opt,name=n_r_enum,json=nREnum,proto3,enum=proto.ASomeEnum3" json:"n_r_enum,omitempty"`
	...
	EnumFromContext    SomeEnum                       `protobuf:"varint,11,opt,name=enum_from_context,json=enumFromContext,proto3,enum=proto.SomeEnum" json:"enum_from_context,omitempty"`
	...
	UnwrappedField       *wrappers.FloatValue `protobuf:"bytes,18,opt,name=unwrapped_field,json=unwrappedField,proto3" json:"unwrapped_field,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (*A) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_fef049599ab3f8fd, []int{2}
}
...
func (*AOneOffs) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_fef049599ab3f8fd, []int{3}
}
...
func (*MsgWithEmpty) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_fef049599ab3f8fd, []int{4}
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_fef049599ab3f8fd, []int{5}
}
...
type B struct {
	...
	RScalar              []int32                        `protobuf:"varint,5,rep,packed,name=r_scalar,json=rScalar,proto3" json:"r_scalar,omitempty"`
	REnum                []SomeEnum                     `protobuf:"varint,6,rep,packed,name=r_enum,json=rEnum,proto3,enum=proto.SomeEnum" json:"r_enum,omitempty"`
	NREnum               SomeEnum                       `protobuf:"varint,7,opt,name=n_r_enum,json=nREnum,proto3,enum=proto.SomeEnum" json:"n_r_enum,omitempty"`
	NRScalar             int32                          `protobuf:"varint,8,opt,name=n_r_scalar,json=nRScalar,proto3" json:"n_r_scalar,omitempty"`
	NRMsg                *timestamp.Timestamp           `protobuf:"bytes,9,opt,name=n_r_msg,json=nRMsg,proto3" json:"n_r_msg,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
...
func (*B) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_fef049599ab3f8fd, []int{6}
}
...
func init() {
	proto.RegisterType((*ListSomeEntitiesRequest)(nil), "proto.ListSomeEntitiesRequest")
	proto.RegisterType((*ListSomeEntitiesRequest_Filter)(nil), "proto.ListSomeEntitiesRequest.Filter")
	proto.RegisterType((*ListSomeEntitiesResponse)(nil), "proto.ListSomeEntitiesResponse")
	proto.RegisterType((*ListSomeEntitiesResponse_SomeEntity)(nil), "proto.ListSomeEntitiesResponse.SomeEntity")
	proto.RegisterType((*A)(nil), "proto.A")
	proto.RegisterMapType((map[int32]SomeEnum)(nil), "proto.A.MapEnumEntry")
	proto.RegisterMapType((map[int32]*timestamp.Timestamp)(nil), "proto.A.MapMsgEntry")
	proto.RegisterMapType((map[int32]int32)(nil), "proto.A.MapScalarEntry")
	proto.RegisterType((*AOneOffs)(nil), "proto.AOneOffs")
	proto.RegisterType((*MsgWithEmpty)(nil), "proto.MsgWithEmpty")
	proto.RegisterType((*Empty)(nil), "proto.Empty")
	proto.RegisterType((*B)(nil), "proto.B")
	proto.RegisterMapType((map[int32]SomeEnum)(nil), "proto.B.MapEnumEntry")
	proto.RegisterMapType((map[int32]*timestamp.Timestamp)(nil), "proto.B.MapMsgEntry")
	proto.RegisterMapType((map[int32]int32)(nil), "proto.B.MapScalarEntry")
	proto.RegisterEnum("proto.SomeEnum", SomeEnum_name, SomeEnum_value)
	proto.RegisterEnum("proto.ASomeEnum3", ASomeEnum3_name, ASomeEnum3_value)
}
...
func (c *serviceExampleClient) GetQueryMethod(ctx context.Context, in *AOneOffs, opts ...grpc.CallOption) (*B, error) {
	out := new(B)
	err := c.cc.Invoke(ctx, "/proto.ServiceExample/getQueryMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceExampleClient) MutationMethod(ctx context.Context, in *B, opts ...grpc.CallOption) (*A, error) {
	out := new(A)
	err := c.cc.Invoke(ctx, "/proto.ServiceExample/mutationMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceExampleClient) QueryMethod(ctx context.Context, in *timestamp.Timestamp, opts ...grpc.CallOption) (*timestamp.Timestamp, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.ServiceExample/queryMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceExampleClient) GetMutatuionMethod(ctx context.Context, in *MsgWithEmpty, opts ...grpc.CallOption) (*MsgWithEmpty, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.ServiceExample/getMutatuionMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceExampleClient) GetEmptiesMsg(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/proto.ServiceExample/getEmptiesMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceExampleClient) ListSomeEntities(ctx context.Context, in *ListSomeEntitiesRequest, opts ...grpc.CallOption) (*ListSomeEntitiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.ServiceExample/ListSomeEntities", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ServiceExample_GetQueryMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ServiceExample/GetQueryMethod",
	}
...
func _ServiceExample_MutationMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ServiceExample/MutationMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceExample_QueryMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ServiceExample/QueryMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceExample_GetMutatuionMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ServiceExample/GetMutatuionMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceExample_GetEmptiesMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ServiceExample/GetEmptiesMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceExample_ListSomeEntities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ServiceExample/ListSomeEntities",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ServiceExample_serviceDesc = grpc.ServiceDesc{
	ServiceName: "proto.ServiceExample",
...
func init() { proto.RegisterFile("proto/example.proto", fileDescriptor_example_fef049599ab3f8fd) }

var fileDescriptor_example_fef049599ab3f8fd = []byte{
	// 1068 bytes of a gzipped FileDescriptorProto
	,
}
