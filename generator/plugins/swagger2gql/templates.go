...
func templatesMethod_callerGohtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/method_caller.gohtml", size: 214, mode: os.FileMode(436), modTime: time.Unix(1539090323, 0)}
...
func templatesMethod_caller_nullGohtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/method_caller_null.gohtml", size: 111, mode: os.FileMode(436), modTime: time.Unix(1539090323, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
