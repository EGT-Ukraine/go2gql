...
func templatesTypes_bodyGohtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/types_body.gohtml", size: 14496, mode: os.FileMode(420), modTime: time.Unix(1533121947, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
