...
func templatesSchemas_bodyGohtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/schemas_body.gohtml", size: 1836, mode: os.FileMode(420), modTime: time.Unix(1534858648, 0)}
...
func templatesTypes_bodyGohtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/types_body.gohtml", size: 14512, mode: os.FileMode(420), modTime: time.Unix(1534843023, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
